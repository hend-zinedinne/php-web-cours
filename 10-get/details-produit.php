...
if ($id === '') {
    ...
    $messageErreur = "URL invalide : Identifiant doit être une valeur numérique positive.";
} else {
    ...
    if ($produitRecherche === null) {
        $messageErreur = "Le produit que vous cherchez n'existe pas dans le catalogue.";
    }
}
